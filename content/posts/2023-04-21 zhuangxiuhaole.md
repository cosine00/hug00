...
主题选用的是蓝色托帕石 Blue Topaz，它有完整的主题示例库，丰富的特性和色彩搭配。参考示例库倒腾了一个主页，把自己的工作流嵌入其中，集功能和颜值于一身。

![](https://api.onedrive.com/v1.0/shares/s!AvbwY01LMvkHjrBsPq8BCz2wWzgdXQ/root/content)
![](https://api.onedrive.com/v1.0/shares/s!AvbwY01LMvkHjrBtwuQv6A4nL63yyQ/root/content)
![](https://api.onedrive.com/v1.0/shares/s!AvbwY01LMvkHjrBuS-quSAXXzkTilA/root/content)
